...
class CriarQuantidadeRefeicaoDialog extends StatefulWidget {
  const CriarQuantidadeRefeicaoDialog({super.key});

  @override
  State<CriarQuantidadeRefeicaoDialog> createState() =>
      _CriarQuantidadeRefeicaoDialogState();
}

class _CriarQuantidadeRefeicaoDialogState
    extends State<CriarQuantidadeRefeicaoDialog> {
  ...
  void _salvar() {
    if (_formKey.currentState!.validate()) {
      final quantidade = QuantidadeRefeicao(
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      title: const Text('Criar Nova Tipo de refeição'),
      content: Form(
        key: _formKey,
